import { RECEIVE_USERS, ADD_USER, ADD_USER_QUESTION,REMOVE_USER, REMOVE_USER_QUESTION, ADD_USER_ANSWER, REMOVE_USER_ANSWER } from "../actions/users";
...
export default function users (state={}, action){
  ...
  return {
    ...
    [action.user]: {
      ...state[action.user],
      questions: state[action.user].questions.filter( questionId => questionId!== action.questionId)
    }
  } 
